            ...
            <div class="content-half__box">
                <div class="form__wrap">
                    <? if ($USER->IsAuthorized()): ?>
                        <p class="form__text">Вы зарегистрированы на сервере и успешно авторизованы.</p>
                    <? else: ?>
                        <?
                        ...
                        elseif ($arResult["USE_EMAIL_CONFIRMATION"] === "Y"):
                            ?>
                            <p class="form__text"><? echo GetMessage("REGISTER_EMAIL_WILL_BE_SENT") ?></p>
                        <? endif ?>
                        <form method="post"
                              class="form js-form validator"
                            ...
                            if ($arResult["USE_CAPTCHA"] == "Y") {
                                ...
                                <tr>
                                    <td><?= GetMessage("REGISTER_CAPTCHA_PROMT") ?>:<span class="starrequired">*</span>
                                    </td>
                            ...
                            <div class="form__text">
                                ...
                                <a class="form__link" href="/policy/">политикой персональных данных</a>
                            </div>
